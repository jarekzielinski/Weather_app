class WeatherForecast5Model {
  ...
  WeatherForecast5Model(
      {this.cod, this.message, this.cnt, this.list, this.city});

  WeatherForecast5Model.fromJson(Map<String, dynamic> json) {
    cod = json['cod'];
...
class Lista {
  ...
  Lista.fromJson(Map<String, dynamic> json) {
    ...
    snow = json['snow'] != null ? new Rain.fromJson(json['snow']) : null;
  }
